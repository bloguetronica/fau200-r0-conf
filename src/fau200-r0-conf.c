/* FAU200 Rev. 0 Configuration Program - Version 1.0 for Debian Linux
...
int main(int argc, char **argv)
{
    ...
    {
        fprintf(stderr, "Error: Missing argument.\nUsage: fau200-r0-conf SERIALNUMBER\n");
...
{
    unsigned char control_buf_out[64] = {
        0x2A, 0x03, 0x46, 0x00, 0x41, 0x00, 0x55, 0x00,  // FAU200 Power Supply
        0x32, 0x00, 0x30, 0x00, 0x30, 0x00, 0x20, 0x00,
...
{
    unsigned char control_buf_out[64] = {
        0x1C, 0x03, 0x46, 0x00, 0x32, 0x00, 0x30, 0x00,  // F20-00xxxxxx
